...
namespace Venda.Infrastructure.Migrations
{
    ...
    [Migration("20251111182832_AddOptimizedIndexesWithDescendingOrder")]
    partial class AddOptimizedIndexesWithDescendingOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Venda.Domain.Aggregates.VendaAgregado", b =>
                {
                    ...
                    b.HasIndex("FilialId", "Data")
                        .IsDescending(false, true)
                        .HasDatabaseName("IX_Vendas_FilialId_Data");

                    b.HasIndex("FilialId", "NumeroVenda")
                        .IsUnique()
                    ...
                    b.HasIndex("Data", "Status", "ClienteId", "FilialId")
            ...
            modelBuilder.Entity("Venda.Infrastructure.Entities.NumeroVendaSequence", b =>
                {
                    b.Property<Guid>("FilialId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("NumeroVendaSequences", (string)null);
                });
